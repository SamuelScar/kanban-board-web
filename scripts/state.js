...
const utilitariosEstado = Kanban.utilitarios;
...
function criarColuna(titulo) {
  const tituloNormalizado = utilitariosEstado.normalizarTexto(titulo) || "Nova coluna";

  return {
    id: utilitariosEstado.criarId("coluna"),
...
function criarCartao(titulo) {
  const tituloNormalizado = utilitariosEstado.normalizarTexto(titulo) || "Novo cartao";

  return {
    id: utilitariosEstado.criarId("cartao"),
    titulo: tituloNormalizado,
    descricao: "",
  };
}
...
function atualizarTituloColuna(estadoQuadro, idColuna, titulo) {
  const tituloNormalizado = utilitariosEstado.normalizarTexto(titulo);
...
function atualizarDescricaoCartao(estadoQuadro, idColuna, idCartao, descricao) {
  const descricaoNormalizada = utilitariosEstado.normalizarTexto(descricao);
...
function atualizarCorCartao(estadoQuadro, idColuna, idCartao, cor) {
  const corNormalizada = utilitariosEstado.normalizarCorHexadecimal(cor);

  return comCartaoAtualizado(estadoQuadro, idColuna, idCartao, function atualizarCor(cartao) {
    const corAtual = utilitariosEstado.normalizarCorHexadecimal(cartao.cor);
