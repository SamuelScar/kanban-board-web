      ...
      {(provided) => (
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="button"
            className="flex-shrink-0 flex items-center justify-center gap-2 w-[85vw] max-w-[320px] sm:w-[320px] h-[72px] rounded-2xl bg-white/40 hover:bg-white/60 backdrop-blur-md border border-white/50 text-black/60 hover:text-black/90 font-medium transition-colors shadow-sm cursor-pointer"
